...
//function check() {
//    if (document.getElementById('name').value == 0 || document.getElementById('comment').value == 0) {
//        toastr["error"]("Please fill all fields first!", "Error");
//    } else {
//        toastr["success"]("Hi " + document.getElementById('name').value + "!<br>Welcome to js test!", "Welcome!");
//        toastr["info"](document.getElementById('comment').value, document.getElementById('name').value + " said:");
//    }
//}
toastr.options = {
    "closeButton": false,
